<div id="dvoPagSeguro">
    ...
    <div class="pag-titulo" onclick="_clickOpcPagSeguroSL()">PagSeguro UOL</div>

    <div style="display: none" id="div-opc-pagseguro" class="opc-container">

        <div>

            <label>
                <input type="radio" name="pay_with" id="pay_with6" value="pagseguro" onclick="_clickOpcPagSeguroSL()">
                <img src="../storage/br/assine-pagseguro-logo2.png" alt="Pag Seguro" width="209" height="48" border="0" align="middle">
            </label>

        </div>

        <div class="selo-ssl"><!-- Begin DigiCert site seal HTML and JavaScript -->
            <div id="DigiCertClickIDeJ_YICf" data-language="en_US">
                <div id="DigiCertClickIDeJ_YICfSeal" style="text-decoration: none; text-align: center; display: block; vertical-align: baseline; font-size: 100%; font-style: normal; text-indent: 0px; line-height: 1; width: auto; margin: 0px auto; padding: 0px; border: 0px; background: transparent; position: relative; top: 0px; right: 0px; bottom: 0px; left: 0px; clear: both; float: none; cursor: default;">
                    <img src="//seal.digicert.com/seals/cascade/?s=_eJ_YICf,13,s,www.belladasemana.com.br" alt="DigiCert Seal" tabindex="0" style="text-decoration: none; text-align: center; display: block; vertical-align: baseline; font-size: 100%; font-style: normal; text-indent: 0px; line-height: 1; width: auto; margin: 0px auto; padding: 0px; border: 0px; background: transparent; position: relative; top: 0px; right: 0px; bottom: 0px; left: 0px; clear: both; float: none; cursor: pointer;">
                </div>
                <span style="text-decoration: none; text-align: center; display: block; vertical-align: baseline; font-size: 100%; font-style: normal; text-indent: 0px; line-height: 1; width: auto; margin: 0px auto; padding: 0px; border: 0px; background: transparent; position: relative; top: 0px; right: 0px; bottom: 0px; left: 0px; clear: both; float: none; cursor: default; color: black;">
        ...
        <div><img src="../storage/2015/assine-bandeiras-pagseguro2.jpg" width="620" height="207" alt="Pagseguro - Formas de pagamento aceitas"></div>
